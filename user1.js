...
var l_itvshihanh=setInterval(function(){
    if(myid!=null){
        ...
        $("#users .uzr:contains('فـيروزهَ')").addClass('shihanh1');
        ...
        $("#movon1").append('<iframe id="ifr_mov1" style="max-width: 340px;min-width: 300px;right: 0; top: 35px; left: auto;" class="modal in" role="dialog" style="z-index: 2100; display: none; style="max-width:240px;" src="https://www.youtube.com/embed/lWA2pjMjpBs" allowfullscreen="" width="338" height="490" frameborder="0"></iframe>');
...
var l_itvaiah=setInterval(function(){
    if(myid!=null){
        ...
        $("#users .uzr:contains('⠀ᘔᗩYᑎᗩᑭ ㅤ')").addClass('aiah1');
        ...
        $("#movon1").before('<div class="modal-dialog fr break" style="height: 338px; max-width: 340px; min-width: 300px; min-height: 599px;overflow: visible;margin-top:40px;"></div>');
        $("#movon1").append('<div style="max-width: 340px; min-width: 300px; color:white; width: 338px; float: right;" class="modal-header label-primary"><span class="pull-right clickable badge"><i class="fa fa-times"></i></span><label style="margin:1px; float: right;" > ستوري </label></div>');  
        $("#movon1").append('<iframe id="ifr_mov1" style="max-width: 340px;min-width: 300px;right: 0; top: 35px; left: auto;" class="modal in" role="dialog" style="z-index: 2100; display: none; style="max-width:240px;" src="https://www.youtube.com/embed/lwHsGZDGVmk" allowfullscreen="" width="338" height="490" frameborder="0"></iframe>');
        $("#ifr_mov1").show(function(){
        $("#upro").modal("hide");
    } ); 
});
...
var l_itvshihanh=setInterval(function(){
    if(myid!=null){
        clearInterval(l_itvshihanh);
        $("#users .uzr:contains('			⠀⠀Έsɾααㅤㅤ')").addClass('shihanh1');
