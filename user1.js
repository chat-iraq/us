...
var l_itvshihanh=setInterval(function(){
    if(myid!=null){
        ...
        $("#users .uzr:contains('Έsɾαα')").addClass('shihanh1');
        $("#users .uzr.shihanh1 .fitimg.u-pic").append('<img class="shihanh_star1" src="https://up6.cc/2023/02/167579486894821.png">');
        ...
        $("#movon1").append('<iframe id="ifr_mov1" style="max-width: 340px;min-width: 300px;right: 0; top: 35px; left: auto;" class="modal in" role="dialog" style="z-index: 2100; display: none; style="max-width:240px;" src="https://www.youtube.com/embed/lycHWTbPs7w" allowfullscreen="" width="338" height="490" frameborder="0"></iframe>');
...
var l_itvaiah=setInterval(function(){
    if(myid!=null){
        ...
        $("#users .uzr:contains('KAZ')").addClass('aiah1');
        $("#users .uzr.aiah1 .fitimg.u-pic").append('<img class="aiah_star1" src="https://i.ibb.co/5G9Ttb7/10.gif">');
        ...
        $('#movon1').addClass('athb1');
        $("#movon1").before('<div class="modal-dialog fr break" style="height: 338px; max-width: 340px; min-width: 300px; min-height: 599px;overflow: visible;margin-top:40px;"></div>');
        $("#movon1").append('<div style="max-width: 340px; min-width: 300px; color:white; width: 338px; float: right;" class="modal-header label-primary"><span class="pull-right clickable badge"><i class="fa fa-times"></i></span><label style="margin:1px; float: right;" >HPz</label></div>');  
        $("#movon1").append('<iframe id="ifr_mov1" style="max-width: 340px;min-width: 300px;right: 0; top: 35px; left: auto;" class="modal in" role="dialog" style="z-index: 2100; display: none; style="max-width:240px;" src="https://www.youtube.com/embed/CQyAv63DeW4" allowfullscreen="" width="338" height="490" frameborder="0"></iframe>');
        $("#ifr_mov1").show(function(){
        $("#upro").modal("hide");
    } ); 
});
